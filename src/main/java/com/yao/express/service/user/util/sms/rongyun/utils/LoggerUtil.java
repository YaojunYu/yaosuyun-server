...
import com.yao.express.service.user.util.sms.rongyun.CCPRestSmsSDK;
...
public class LoggerUtil {
	...
	static {
		if (logger == null) {
			logger = Logger.getLogger(com.yao.express.service.user.util.sms.rongyun.CCPRestSmsSDK.class);
