 ...
 */
package com.yao.express.service.user.util.sms.rongyun;

import com.google.gson.JsonArray;
import com.google.gson.JsonElement;
import com.google.gson.JsonObject;
import com.google.gson.JsonParser;
import com.yao.express.service.user.util.sms.rongyun.utils.CcopHttpClient;
import com.yao.express.service.user.util.sms.rongyun.utils.DateUtil;
import com.yao.express.service.user.util.sms.rongyun.utils.EncryptUtil;
import com.yao.express.service.user.util.sms.rongyun.utils.LoggerUtil;
...
public class CCPRestSmsSDK {
	...
	public void init(String serverIP, String serverPort) {
		if (isEmpty(serverIP) || isEmpty(serverPort)) {
			com.yao.express.service.user.util.sms.rongyun.utils.LoggerUtil.fatal("初始化异常:serverIP或serverPort为空");
	...
	public void setAccount(String accountSid, String accountToken) {
		if (isEmpty(accountSid) || isEmpty(accountToken)) {
			com.yao.express.service.user.util.sms.rongyun.utils.LoggerUtil.fatal("初始化异常:accountSid或accountToken为空");
	...
	public void setAppId(String appId) {
		if (isEmpty(appId)) {
			com.yao.express.service.user.util.sms.rongyun.utils.LoggerUtil.fatal("初始化异常:appId为空");
	...
	public HashMap<String, Object> sendTemplateSMS(String to, String templateId, String[] datas) {
		...
		com.yao.express.service.user.util.sms.rongyun.utils.CcopHttpClient chc = new CcopHttpClient();
		...
		try {
			...
			com.yao.express.service.user.util.sms.rongyun.utils.LoggerUtil.info("sendTemplateSMS Request body =  " + requsetbody);
			...
			e.printStackTrace();
			com.yao.express.service.user.util.sms.rongyun.utils.LoggerUtil.error(e.getMessage());
		...
		com.yao.express.service.user.util.sms.rongyun.utils.LoggerUtil.info("sendTemplateSMS response body = " + result);
	...
	private HttpRequestBase getHttpRequestBase(int get, String action) throws NoSuchAlgorithmException, UnsupportedEncodingException {
		String timestamp = com.yao.express.service.user.util.sms.rongyun.utils.DateUtil.dateToStr(new Date(), DateUtil.DATE_TIME_NO_SLASH);
		com.yao.express.service.user.util.sms.rongyun.utils.EncryptUtil eu = new EncryptUtil();
		String sig = "";
		String acountName = "";
